...
class SearchStatistics
{
    public:
        ...
        int generated_live_branched_states;

        /// Count statistics for one generated child
        void countChild(int openListIndex);

        /// Count a new state generated by branching an ungrounded op.
        void countLiveBranch(int openListIndex);
    ...
    private:
        ...
        int lastDumpGeneratedLiveBranchedStates;
        time_t lastDumpTime;
        time_t startTime;
};
