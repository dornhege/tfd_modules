#ifndef ACTION_EXECUTOR_PUTDOWN_SPONGE_H
#define ACTION_EXECUTOR_PUTDOWN_SPONGE_H
...
namespace tidyup_actions
{
    ...
    class ActionExecutorPutdownSponge : public ActionExecutorService<std_srvs::Empty>
    {
        public:
