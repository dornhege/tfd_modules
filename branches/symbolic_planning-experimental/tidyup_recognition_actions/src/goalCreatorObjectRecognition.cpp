#include "tidyup_recognition_actions/goalCreatorObjectRecognition.h"
#include <pluginlib/class_list_macros.h>
#include "hardcoded_facts/geometryPoses.h"
#include <ros/ros.h>

PLUGINLIB_DECLARE_CLASS(tidyup_recognition_actions, goal_creator_object_recognition,
        tidyup_recognition_actions::GoalCreatorObjectRecognition, continual_planning_executive::GoalCreator)

namespace tidyup_recognition_actions
{

    GoalCreatorObjectRecognition::GoalCreatorObjectRecognition()
    {
    }
    ...
    bool GoalCreatorObjectRecognition::fillStateAndGoal(SymbolicState & currentState, SymbolicState & goal)
    {
