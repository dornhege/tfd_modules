#include "tidyup_recognition_actions/stateCreatorObjectRecognition.h"
#include <pluginlib/class_list_macros.h>

PLUGINLIB_DECLARE_CLASS(tidyup_recognition_actions, state_creator_object_recognition,
        tidyup_recognition_actions::StateCreatorObjectRecognition, continual_planning_executive::StateCreator)

namespace tidyup_recognition_actions
{

StateCreatorObjectRecognition::StateCreatorObjectRecognition()
{
...
bool StateCreatorObjectRecognition::fillState(SymbolicState & state)
{
