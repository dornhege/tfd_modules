...
namespace tidyup_place_actions
{
    ...
    class ActionExecutorTidyupPlaceObject : public ActionExecutorActionlib<tidyup_msgs::GraspObjectAction,
                                                    tidyup_msgs::GraspObjectGoal, tidyup_msgs::GraspObjectResult>
    {
        public:
            ...
            virtual void updateState(const actionlib::SimpleClientGoalState & actionReturnState, const tidyup_msgs::GraspObjectResult & result,
