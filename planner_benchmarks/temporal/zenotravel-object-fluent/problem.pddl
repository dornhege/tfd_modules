...
(:init (= (at plane1) city1)
       ...
       (= (at-or-in person1) city3)
       (= (at-or-in person2) city0)
       (= (at-or-in person3) city0)
       (= (at-or-in person4) city1)
...
(:goal (and (= (at-or-in person1) city2)
            (= (at-or-in person2) city3)
            (= (at-or-in person3) city3)
            (= (at-or-in person4) city3)))
