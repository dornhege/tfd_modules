(define (domain TransportModules)
  ...
  (:oplinit initCallbackInterface@libtfd_opl_Transport.so)
  (:types
    Target - Object
    Location - Object
    Locatable - Object
  ...
  (:modules
    (Vehicle_canLoad ?this - Vehicle  ?p - Package conditionchecker Vehicle_canLoad_plannerCall@libtfd_opl_Transport.so)
  )
  (:predicates
