...
(define (problem transport-p21-30-city-hubs-5hubs-3htrucks-4citysize-1ctrucks-12packages-2008)
 ...
 (:init
  ...
  (= (Package_size p5) 20)
  (Locatable_at p5 city-0-3)
  (= (Package_size p6) 10)
  (Locatable_at p6 city-1-0)
  (= (Package_size p7) 20)
  (Locatable_at p7 city-2-1)
  (= (Package_size p8) 10)
  (Locatable_at p8 city-3-2)
  (= (Package_size p9) 20)
  (Locatable_at p9 city-4-3)
  (= (Package_size p10) 10)
  (Locatable_at p10 city-0-0)
  (= (Package_size p11) 20)
  (Locatable_at p11 city-1-1)
 )
 (:goal (and
  (Locatable_at p0 city-2-2)
  (Locatable_at p1 city-3-1)
  (Locatable_at p2 city-4-0)
  ...
  (Locatable_at p10 city-2-0)
  (Locatable_at p11 city-3-3)
  (Locatable_at v0 hub-0)
  (Locatable_at v1 hub-1)
  (Locatable_at v2 hub-2)
  (Locatable_at ctruck-0-0 hub-0)
