...
(define (problem transport-p21-30-city-hubs-5hubs-3htrucks-3citysize-1ctrucks-10packages-2008)
 ...
 (:init
  ...
  (road hub-4 hub-0)
  (= (roadLength hub-4 hub-0) 20)
  (= (fuelDemand hub-4 hub-0) 15)
  (road hub-0 hub-4)
  (= (roadLength hub-0 hub-4) 20)
  (= (fuelDemand hub-0 hub-4) 15)
  ...
  (road city-0-1 hub-0)
  (= (roadLength city-0-1 hub-0) 3)
  (= (fuelDemand city-0-1 hub-0) 2)
  (road hub-0 city-0-1)
  (= (roadLength hub-0 city-0-1) 3)
  (= (fuelDemand hub-0 city-0-1) 2)
  ...
  (road city-3-2 hub-3)
  (= (roadLength city-3-2 hub-3) 3)
  (= (fuelDemand city-3-2 hub-3) 2)
  (road hub-3 city-3-2)
  (= (roadLength hub-3 city-3-2) 3)
  (= (fuelDemand hub-3 city-3-2) 2)
  ...
  (= (roadLength city-4-1 city-4-2) 10)
  (= (fuelDemand city-4-1 city-4-2) 12)
  (road city-4-2 city-4-1)
  (= (roadLength city-4-2 city-4-1) 10)
  (= (fuelDemand city-4-2 city-4-1) 12)
  (road city-4-2 hub-4)
  ...
  (= (Package_size p5) 20)
  (Locatable_at p5 city-0-0)
  (= (Package_size p6) 10)
  (Locatable_at p6 city-1-1)
  (= (Package_size p7) 20)
  (Locatable_at p7 city-2-2)
  (= (Package_size p8) 10)
  (Locatable_at p8 city-3-0)
  (= (Package_size p9) 20)
  (Locatable_at p9 city-4-1)
 )
 (:goal (and
  (Locatable_at p0 city-2-1)
  (Locatable_at p1 city-3-0)
  (Locatable_at p2 city-4-2)
  (Locatable_at p3 city-0-1)
  (Locatable_at p4 city-1-0)
  (Locatable_at p5 city-2-2)
  (Locatable_at p6 city-3-1)
  (Locatable_at p7 city-4-0)
  (Locatable_at p8 city-0-2)
  (Locatable_at p9 city-1-1)
  (Locatable_at v0 hub-0)
  (Locatable_at v1 hub-1)
  (Locatable_at v2 hub-2)
  (Locatable_at ctruck-0-0 hub-0)
