(define (domain CrewPlanningOpl)
  ...
  (:oplinit initCallbackInterface@libtfd_opl_CrewPlanningOpl.so)
  (:types
    MedicalState - Object
    FilterState - Object
    Day - Object
  ...
  (:modules
    (CrewMember_availableModule ?this - CrewMember conditionchecker CrewMember_availableModule_plannerCall@libtfd_opl_CrewPlanningOpl.so)
  )
  (:predicates
  ...
  (:durative-action CrewMember_haveMeal
    ...
    :condition (and
      ...
      (at start ([CrewMember_availableModule ?this]))
