(define (problem CrewPlanning_3crew_2day_100utilization)
  ...
  (:goal (and
      ...
      (PayloadAct_completed pa1_16 d1)
      (PayloadAct_completed pa1_17 d1)
      (PayloadAct_completed pa1_18 d1)
      (PayloadAct_completed pa1_19 d1)
      (PayloadAct_completed pa1_20 d1)
      (PayloadAct_completed pa1_21 d1)
      (PayloadAct_completed pa1_22 d1)
      ...
      (PayloadAct_completed pa2_20 d2)
      (PayloadAct_completed pa2_21 d2)
      (PayloadAct_completed pa2_22 d2)
      (PayloadAct_completed pa2_23 d2)
      (PayloadAct_completed pa2_24 d2)
